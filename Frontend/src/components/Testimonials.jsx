      ...
      <div className="container">
        ...
        <div className="card-grid">
          <div className="card">
            ...
            <h3 style={{ marginTop: "1rem" }}>Local Client</h3>
          </div>
          ...
          <div className="card" data-aos="zoom-in">
            ...
            />
            <p>
              "Mwen te jwenn yon sèvis trè pwofesyonèl. Yo te pran tan pou ede m
              konprann dokiman mwen yo epi yo te trete m ak anpil respè."
            </p>
          ...
          <div className="card" data-aos="zoom-in">
            ...
            <h3 style={{ marginTop: "1rem" }}>Returning Client</h3>
          </div>
          ...
          <div className="card" data-aos="zoom-in">
            ...
            <h3 style={{ marginTop: "1rem" }}>First-Time Client</h3>
          </div>
