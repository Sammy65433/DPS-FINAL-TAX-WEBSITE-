            ...
            <div className="container">
                ...
                <div className="card-grid testimonials-grid">
                    ...
                    <div className="card testimonial-preview-card">
                        ...
                        />
                        <div className="testimonial-preview-content">
                            <div className="testimonial-badge">Kreyòl</div>
                    ...
                    <div className="card testimonial-preview-card">
                        ...
                        />
                        <div className="testimonial-preview-content">
                            <div className="testimonial-badge">French</div>
                            <h3>French-Speaking Client</h3>
                            <p>
                                "Service très professionnel et chaleureux. On a pris le temps
                                de tout m’expliquer clairement, ce qui m’a tout de suite mis en
                                confiance."
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="card testimonial-preview-card">
                        ...
                        />
                        <div className="testimonial-preview-content">
                            <div className="testimonial-badge">Spanish</div>
